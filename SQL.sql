...
INSERT INTO USERS (userid, username, password, name, email, loggedIn)
VALUES ('1', 'Matt77','m', 'Mateo Paizano','matt@yahoo.com', false);
INSERT INTO USERS (userid, username, password, name, email, loggedIn)
VALUES ('2', 'Ali','p', 'Alibaba','Ali@yahoo.com', false);
INSERT INTO USERS (userid, username, password, name, email, loggedIn)
VALUES ('3', 'Saratoga22','Springs', 'Sandy Cave','Candy@gmail.com', false);
INSERT INTO USERS (userid, username, password, name, email, loggedIn)
VALUES ('4', 'SantaHasAgift','hohoho', 'Harry Santa','harry@aol.com', false);
...
Update USERS SET loggedIn = false WHERE loggedin = true;
